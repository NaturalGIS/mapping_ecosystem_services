...
read -p "Absolute or relative path to a GEOPACKAGE datasource containing the study area boundaries, the land use map and the classification table: " datasource
